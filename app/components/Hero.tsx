      ...
      <div className="hero__content mt-[3rem] absolute top-[20%] left-0 w-full h-full small:top-0 ">
        <div className="hero__content__container w-full h-full small:flex small:justify-between small:gap-[7rem] small:items-center small:px-layout-small max-w-screen-large mx-auto">
          <div className="hero__text flex flex-col items-start justify-center max-w-[625px] z-20 mx-auto px-[5%] small:ml-0  small:pr-0 small:pl-0">
            <h1 className="text-white font-sans text-center mx-auto text-[clamp(2rem,2.2cqw,2.4rem)] font-semibold w-full max-w-[500px] small:ml-0 small:text-left tracking-wider">
          ...
          <div className="hero__image z-20 px-[5%] mx-auto mt-[20%] xsmall:mt-[clamp(5rem,30vw,9rem)] small:mx-0 small:mt-[22%] w-[93%] h-full max-w-[clamp(560px,70vw,700px)] align-middle translate-x-[2%] small:max-w-[clamp(300px,50vw,720px)] small:w-full small:translate-x-[5%] small:px-0">
            <HeroSwiper />
          </div>
        </div>
      </div>
