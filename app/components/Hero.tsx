      ...
      <div className="hero__content mt-[3rem] absolute top-[20%] left-0 w-full h-full ">
        <div className="hero__content__container w-full h-full  max-w-screen-large mx-auto">
          <div className="hero__text flex flex-col items-start justify-center max-w-[625px] z-20 mx-auto px-[5%] small:px-0">
            <h1 className="text-white font-sans text-center mx-auto text-[clamp(2rem,2.2cqw,2.4rem)] font-semibold w-full max-w-[500px] tracking-wider">
              Freelance Web Developer crafting fast, fluid and high performing
              websites
            </h1>
            <p className="text-white text-[1.4rem] mt-[2rem] max-w-[500px] text-center mx-auto leading-[1.8em] small:max-w-[600px] ">
          ...
          <div className="hero__image z-20 px-[5%] mx-auto mt-[20%] xsmall:mt-[clamp(5rem,30vw,9rem)] small:mx-auto small:mt-[5rem] w-[93%] h-full max-w-[clamp(560px,70vw,700px)] align-middle translate-x-[2%]">
            <HeroSwiper />
          </div>
        </div>
      </div>
